  ...
  return (
    <>
      <StyledMainBox id="home">
        <div className="flex justify-center items-center p-40 text-center" style={{ background: 'linear-gradient(to left, white 50%, #e6e1e1 50%)' }}>
          <div className="text-xl text-gray-700 px-10">
            ...
            <RotatingText2 style={{ fontFamily: "Arial, sans-serif", fontWeight: "700"}} className="md:text-6xl text-5xl mb-0"></RotatingText2>
