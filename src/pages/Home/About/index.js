...
{/* <div className='mb-10'>
<p className='text-m font-semibold text-black mb-3 '>Name : <span className='text-gray-400'>Vikash Yadav</span></p>
<p className='text-m font-semibold text-black mb-3'>Date of Birth : <span className='text-gray-400'>30 Jan, 2002</span></p>
<p className='text-m font-semibold text-black mb-3'>Address : <span className='text-gray-400'>Amraiwadi, Ahmedabad- 380026 Gujarat</span></p>
<p className='text-m font-semibold text-black mb-3'>Email : <span className='text-gray-400'>vikash9412077@gmail.com</span></p>
<p className='text-m font-semibold text-black mb-3'>Phone : <span className='text-gray-400'>7698661812</span></p>
